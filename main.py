...
import time, os, random, threading, argparse
...
def main(args):
    ...
    robot = Robot(args.is_sim, args.obj_mesh_dir, args.num_obj, args.workspace_limits,
                  args.tcp_host_ip, args.tcp_port, args.rtc_host_ip, args.rtc_port,
                  args.is_testing, args.test_preset_cases, args.test_preset_file)
